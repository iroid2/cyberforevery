...
const categoryInfo = {
  bootcamp: {
    titles: [
      "Penetration Lab Simulation",
      "Defense Topology Audit",
      "Threat Vector Intercept",
      "Incident Response Console",
      "Cryptographic Decoupler",
      "Server Firewall Harden",
      "Memory Security Forensics",
      "Network Routing Sandbox",
  ...
  classroom: {
    titles: [
      "Active Terminal Exploration",
      "Hardware Assembly Study",
      "Peer Protocol Alignment",
      "Collaborative Code Review",
      "Visual DNS Diagnostic",
      "System Integrity Lab",
      "Network Interface Config",
      "Mainframe Flow Diagrams",
      "BIOS Interface Sandbox",
    ],
    descriptions: [
  ...
  community: {
    titles: [
      "Cybersecurity Hub Briefing",
      "Intergenerational Web Hub",
      "Neighborhood Defense Sync",
      "Public Safety Hackathon",
      "Inclusive Cyber Meetup",
      "Community Safe-Tech Forum",
      "Digital Literacy Seminar",
      "Parent Awareness Session",
      "Family Tech Safety Sync",
    ],
    descriptions: [
  ...
  creative: {
    titles: [
      "Neural Defense Core",
      "Digital Matrix Gateway",
      "Abstract Packet Stream",
      "Biometric Node Encryption",
      "Silicon Threat Spectrum",
      "Virtual Sandboxed Kernel",
      "Hypervisor Grid Vector",
      "Decentralized Key Ledger",
...
export const galleryItems: GalleryItem[] = uniqueUserImages.map(
  (src, index) => {
