      ...
      <main className="flex-grow flex items-center justify-center px-6 py-32 relative z-10">
        <div className="w-full max-w-md">
          <div className="bg-surface/60 backdrop-blur-xl rounded-lg p-10 border border-border shadow-2xl relative">
            ...
            <div className="mb-8">
              <h2 className="font-headline text-3xl font-bold text-foreground tracking-tight uppercase tracking-tighter">
                AUTHENTICATE
              </h2>
              <p className="text-muted text-xs font-headline tracking-widest uppercase mt-1">
                // ENTRY_POINT_01
              </p>
            </div>
            ...
            <div className="pt-8 text-center">
              <p className="text-xs text-muted tracking-wide">
                NEW AGENT?
                <a className="text-foreground hover:text-primary font-bold ml-1 transition-colors underline decoration-primary/30" href="/register">
                  ENROLL HERE
                </a>
              </p>
            </div>
