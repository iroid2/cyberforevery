        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-100 px-5 py-4">
            ...
            <p className="mt-0.5 text-xs text-slate-400">
              Latest joins across your courses
            </p>
          </div>
          ...
          {recentStudents.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-14 text-center">
              ...
              <p className="mt-1 text-xs text-slate-400">
                Students will appear here once they join a live course.
              </p>
            </div>
          ) : (
...
async function AdminDashboard({ name }: { name: string }) {
  const [tutorCount, courseCount, studentCount, recentStudents, topTutors] =
    await Promise.all([
      prisma.user.count({
        where: {
          role: "TUTOR",
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            {topTutors.length === 0 ? (
              ...
              <div className="divide-y divide-slate-50">
                {topTutors.map((tutor) => {
                  const students = tutor.tutorCourses.reduce(
                    (sum, course) => sum + course._count.students,
                    0,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right text-xs text-slate-500">
                        <p>{tutor.tutorCourses.length} courses</p>
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-slate-400">
                          {student.course.title} · {student.course.tutor?.name}
                        </p>
                      </div>
